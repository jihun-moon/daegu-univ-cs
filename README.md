...
따로 정리한 프로젝트는 이 저장소가 아니라 [별도 저장소](#만든-프로젝트)에 있습니다.
...
| [2학년](2nd-grade/) | 7 | 393 | C, C++/OpenGL, Java, 자료구조와 알고리즘 |
| [3학년](3rd-grade/) | 8 | 5,548 | 안드로이드, 웹, 데이터마이닝, MySQL, 언리얼 |
| [4학년](4th-grade/) | 2 | 25 | 머신러닝, 생성형 AI |

3학년만 5,548개인 것은 게임프로그래밍 때문입니다.
언리얼 프로젝트를 통째로 올리면서 `.uasset` 3,601개와 `.umap` 24개가 들어갔고, LFS 로 올린 용량(포인터에 적힌 크기로 약 19GB)도 99%가 여기서 나왔습니다.
...
| [computer-graphics](2nd-grade/computer-graphics/) | 72 | C++와 OpenGL 실습 (Visual Studio 프로젝트 포함) |
...
| [database](3rd-grade/database/) | 53 | MySQL 챕터별 쿼리 실습과 Python 연동 과제 |
| [software-engineering](3rd-grade/software-engineering/) | 40 | 요구사항과 설계 문서 |
...
| [Lecture-Summarizer-AI](https://github.com/jihun-moon/Lecture-Summarizer-AI) | Whisper 로 강의 음성을 받아쓰는 도구 (요약 기능은 없음) |
